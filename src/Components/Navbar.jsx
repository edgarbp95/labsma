  ...
  return (
    ...
    <div className='flex gap-5 w-full py-2 mx-auto px-20 border-b-2 border-turquoise bg-blackp items-center justify-between text-black  text-base font-medium sm:py-1 sm:px-1 sm:ml-0 sm:hidden md:px-6'>
      ...
      <div className='flex gap-10 items-center'>
        <NavLink className="hover:text-bluew font-bold relative nav_menu_option sm:text-sm" to="/">LABSMA</NavLink>
        <NavLink className="hover:text-bluew font-bold relative nav_menu_option sm:text-sm" to="/">SERVICIOS</NavLink>
        <NavLink className="hover:text-bluew font-bold relative nav_menu_option sm:text-sm" to="/">CONTACTO</NavLink>
      </div>
